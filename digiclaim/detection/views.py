...
def scratchDetection(request):
    ...
    if request.method == 'POST' and request.FILES['image']:
        ...
        cv2.imwrite("/home/DigiClaim/digiclaim/images/" + claim.claim_id + '_' + 'denoised.jpeg', denoised)
        cv2.imwrite("/home/DigiClaim/digiclaim/images/" + claim.claim_id + '_' + 'L1.jpeg', L1)
        cv2.imwrite("/home/DigiClaim/digiclaim/images/" + claim.claim_id + '_' + 'L2.jpeg', L2)

        denoised_img = open("/home/DigiClaim/digiclaim/images/" + claim.claim_id + '_' + 'denoised.jpeg', 'rb')
        l1 = open("/home/DigiClaim/digiclaim/images/" + claim.claim_id + '_' + 'L1.jpeg', 'rb')
        l2 = open("/home/DigiClaim/digiclaim/images/" + claim.claim_id + '_' + 'L2.jpeg', 'rb')
